package com.example.serialmonitor;
...
public class MainActivity extends Activity
{
    ...
    void findBT()
    {
        ...
        if(pairedDevices.size() > 0)
        {
            ...
            {
                if(device.getName().equals("Home Automation")) 
                {
                    mmDevice = device;
                    break;
                }
            ...
            {                
               while(!Thread.currentThread().isInterrupted() && !stopWorker)
               {
                    try 
                    {
                       ...
                       // char[] c = new char[bytesAvailable];
                        if(bytesAvailable > 0)
                        {
                            ...
                            {
                            	///int kk=mmInputStream.read();
                            	//c[i]=(char)kk;
                                
                            	
                            	//String str=Integer.toString(kk);
                            	//Log.d(TAG, str);
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB) @SuppressLint("NewApi") public void ConnectionEstablished(View view) {
        ...
        Notification noti = new Notification.Builder(this)
            ...
            .setContentText("Home Automation").setSmallIcon(R.drawable.ic_launcher)
